...
while [ $retries -lt 3 ]; do
    ...
    ord --rpc-url 146.190.11.6:8332 --bitcoin-rpc-user mempool --bitcoin-rpc-pass mempool --data-dir /root/.local/share/ord/$runDir  --index-only-first-transfer --index-transfer-history --filter-metaprotocol cbrc-20 --filter-metaprotocol "@" server --http-port 8080 -j &>/dev/stdout &
